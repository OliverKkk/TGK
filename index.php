...
<html>
	...
	<body>
		...
		<!-- Header -->
			<header id="header">
				<a href="index.html" class="logo"><strong>TGK</strong></a>
				<nav>
					<a href="#menu">Menu</a>
				</nav>
			</header>
		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					<h1>Your IT Solutions Center<a href=""></a></h1>
					<ul class="actions">
						<li><a href="#one" class="button alt scrolly big">Who we do</a></li>
					</ul>
				</div>
			</section>
		...
		<!-- Two -->
			<article id="two" class="post invert style1 alt">
				...
				<div class="content">
					<div class="inner">
						<header>
							<h2><a href="generic.html">Digital Marketing</a></h2>
		...
		<!-- Three -->
			<article id="three" class="post style2">
				...
				<div class="content">
					<div class="inner">
						<header>
							<h2><a href="generic.html">Graphic design and Print</a></h2>
							<p class="info">3 days ago by <a href="#">Jane Doe</a></p>
						</header>
		...
		<!-- Four -->
			<article id="four" class="post invert style2 alt">
				...
				<div class="content">
					<div class="inner">
						<header>
							<h2><a href="generic.html">Hardware Maintenance</a></h2>
							<p class="info">Repairs, upgrades, troubleshooting <a href="#">by qualified professionals</a></p>
						</header>
		...
		<!-- Five -->
			<article id="five" class="post style3">
				...
				<div class="content">
					<div class="inner">
						<header>
							<h2><a href="generic.html">End-User Training and Support</a></h2>
							<p class="info">3 days ago by <a href="#">Jane Doe</a></p>
						</header>
						<p>xxxxxxxxxxxx</p>
						<ul class="actions">
		...
		<!-- Six -->
			<article id="six" class="post invert style3 alt">
				...
				<div class="content">
					<div class="inner">
						<header>
							<h2><a href="generic.html">AWS Cloud Computing Services</a></h2>
							<p class="info">x<a href="#">x</a></p>
						</header>
						<p>xxx</p>
						<ul class="actions">
							<li><a href="generic.html" class="button alt">Read More</a></li>
